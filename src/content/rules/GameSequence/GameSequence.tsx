    ...
    <Section title="Fase de destí">
      ...
      <Section title="Revelar cartes de focus">
        <p>
          ...
          revelaran {revealedFocusCards} cartes de focus del nivell adequat, situades en una fila visible per a tots els
          jugadors.
        </p>
        <p>
          Al primer torn, totes les cartes de focus robades seran de nivell 1; a mida que el joc avanci, la baralla de
          nivell 1 serà progressivament substituida per les baralles de nivell 2 i 3, proporcionant cartes de focus més
        ...
        <Example>
          <ul>
            <li>Al torn 1, els jugadors revelen {revealedFocusCards} cartes de nivell 1</li>
            <li>Al torn 2, els jugadors revelen {revealedFocusCards - 1} cartes de nivell 1, i una de nivell 2</li>
            <li>Al torn 3, els jugadors revelen {revealedFocusCards - 2} cartes de nivell 1, i dues de nivell 2</li>
            <li>...</li>
            <li>
              Al torn {revealedFocusCards + 1}, els jugadors revelen {revealedFocusCards} cartes de nivell 2
            </li>
            <li>
              Al torn {revealedFocusCards + 2}, els jugadors revelen {revealedFocusCards - 1} cartes de nivell 2 i una
              de nivell 3
            </li>
            <li>
              Al torn {revealedFocusCards + 3}, els jugadors revelen {revealedFocusCards - 2} cartes de nivell 2 i dues
              de nivell 3
            </li>
            <li>...</li>
            <li>
              Al torn {revealedFocusCards * 2 + 1} i posteriors, els jugadors revelen {revealedFocusCards} cartes de
              nivell 3
            </li>
          </ul>
        </Example>
      ...
      <Section title="Escollir cartes de focus">
        <p>
          ...
          torn. Cada jugador fa la seva tria per separat, escollint {eligibleFocusCards} de les cartes i obtenint els
